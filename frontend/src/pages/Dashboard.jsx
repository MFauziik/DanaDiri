...
const getProfileUrl = (pic) => {
  ...
  // Handle corrupted schemes (e.g. from user DB error)
  ...
  if (pic.startsWith('http://') || pic.startsWith('https://') || pic.includes('res.cloudinary.com')) {
    // Optimasi Cloudinary: paksa ukuran kecil (c_fill, w_100, h_100, q_auto)
    if (pic.includes('res.cloudinary.com') && !pic.includes('/upload/c_fill')) {
      return pic.replace('/upload/', '/upload/c_fill,w_100,h_100,q_auto/');
    }
    return pic;
  }
